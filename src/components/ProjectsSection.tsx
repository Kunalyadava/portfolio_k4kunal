...
const projects: Project[] = [
  {
    ...
    description:
      'Healthcare management solution developed for Hi-Tech Medical College & Hospital, covering patient management, billing, scheduling, pharmacy, and inventory workflows with a focus on clarity, compliance, and operational efficiency.',
    githubUrl: 'https://nekss.com/',
    tech: ['Angular', 'TypeScript', 'RxJS', 'Angular Material', 'REST API', 'Healthcare ERP'],
    metrics: [
      { label: 'FOCUS', value: 'Clinical Ops' },
      { label: 'MODULES', value: 'Patient + Billing' },
      { label: 'STACK', value: 'Angular + RxJS' },
    ],
  },
  {
    number: '02',
    title: 'EGP Government Platform',
    category: 'SECURE GOVERNMENT PORTAL',
    description:
      'Secure government-facing platform for international clients developed with microfrontend architecture and strong session security, using module federation, ngRx store, and translation support to improve maintainability and scale.',
    githubUrl: 'https://www.xomic.co.in/index.php',
    tech: ['Angular', 'ngRx', 'Module Federation', 'Webpack', 'ngx-translate', 'RxJS'],
    metrics: [
      { label: 'ARCH', value: 'Microfrontend' },
      { label: 'SECURITY', value: 'OTP Tokens' },
      { label: 'STACK', value: 'ngRx + Webpack' },
    ],
  },
  {
    number: '03',
    title: 'Wonder Cement Website',
    category: 'CORPORATE WEBSITE',
    description:
      'Corporate website built for Wonder Cement, delivering a polished digital presence with responsive layout and structured product information for better browser experience and trust.',
    githubUrl: 'https://wondercement.com',
    tech: ['Angular', 'HTML5', 'CSS3', 'Responsive UI', 'Frontend Dev'],
    metrics: [
      { label: 'VISIBILITY', value: 'Corporate' },
      { label: 'UX', value: 'Responsive' },
      { label: 'DEPLOY', value: 'Live Site' },
    ],
  },
  {
    number: '04',
    title: 'Wonder Cement Dashboard',
    category: 'ANALYTICS DASHBOARD',
    description:
      'Analytics-focused dashboard project designed to present operational data in a high-clarity interface and help teams track performance with cleaner visual communication.',
    githubUrl: 'https://wondercement.com',
    tech: ['Angular', 'TypeScript', 'UI Design', 'Data Views', 'Clean UX'],
    metrics: [
      { label: 'GOAL', value: 'Monitoring' },
