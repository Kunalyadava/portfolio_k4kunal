...
const journey: RouteStop[] = [
  {
    ...
    organization: 'NEKSS PVT. LTD.',
    description: 'Developing and enhancing healthcare ERP solutions for Hi-Tech Medical College & Hospital, covering patient management, billing, scheduling, pharmacy, and inventory modules with performance-focused Angular architecture.',
  },
  {
    id: '02',
    year: 'JUL 2024 - OCT 2024',
    title: 'JR ANGULAR DEVELOPER',
    organization: 'XOMIC INFOTECH PVT. LTD.',
    description: 'Built secure government platform modules, worked with microfrontend architecture and module federation, and strengthened application reliability through ngRx, RxJS, ngx-translate, and OTP-based session security.',
  },
  {
    id: '03',
    year: 'VARIOUS PROJECTS',
    title: 'FREELANCE WEB DEVELOPER',
    organization: 'BLUEBANYAN PVT LTD & CLIENT PROJECTS',
    description: 'Delivered frontend solutions for multiple client engagements while maintaining clear communication, timely delivery, and quality standards across concurrent projects.',
  },
  {
    id: '04',
    ...
    description: 'Completed immersive training in modern web development, covering JavaScript, TypeScript, HTML5, CSS3, and contemporary frontend frameworks.',
  },
  {
    id: '05',
    year: 'JUL 2017 - JAN 2021',
    title: 'BACHELOR OF SCIENCE',
    organization: 'BANGALORE UNIVERSITY',
    description: 'Completed a comprehensive undergraduate program in Sciences, building the academic foundation for technical problem solving and software development.',
  },
];
