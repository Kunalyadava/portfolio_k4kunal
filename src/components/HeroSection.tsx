          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                ANGULAR DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> FRONTEND ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> TYPESCRIPT
              </p>
            </motion.div>
            ...
            >
              <p>
                I craft scalable Angular applications for healthcare, government platforms, and enterprise workflows.
                <br />
                With a focus on clean architecture, reusable UI, strong performance, and business-ready solutions.
              </p>
            </motion.div>
