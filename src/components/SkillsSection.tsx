...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['Angular', 'TypeScript', 'Angular Material', 'Bootstrap'],
    description: 'Building scalable, maintainable single-page applications with reusable components, accessible interfaces, and modern UI patterns.',
    stat: 'V16+',
  ...
  },
  {
    ...
    badge: 'FLOW CONTROL',
    items: ['ngRx Store', 'RxJS', 'Module Federation', 'Microfrontend'],
    description: 'Managing complex state and product flows while improving modularity, reusability, and performance for enterprise platforms.',
    stat: 'LOW LATENCY',
  ...
  },
  {
    ...
    badge: 'TOOLCHAIN',
    items: ['Angular CLI', 'Webpack', 'REST APIs', 'Git', 'GitHub'],
    description: 'Delivering API-driven interfaces with clean development workflows, feature iteration, and maintainable code standards.',
    stat: 'CI READY',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'PRODUCTION',
    items: ['Netlify', 'Firebase', 'AWS', 'GitLab', 'ngx-translate'],
    description: 'Deploying responsive web applications across multiple environments while keeping user experience and platform reliability in focus.',
    stat: 'LIVE READY',
    colSpan: 'lg:col-span-7',
  },
];
