        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I&apos;m <span className="text-[#F3DBB3] font-medium">Kunal Kumar</span>, an Angular Developer with nearly 2 years of experience building scalable, high-performance web applications using Angular, TypeScript, RxJS, Angular Material, and REST APIs. I enjoy solving real-world product problems, collaborating with international teams, and building maintainable systems that feel seamless for end users.
            </motion.p>
